...
const History = ({ currentLanguage = "en" }) => {
  ...
  useEffect(() => {
    ...
    const data = Array.from({ length: 25 }, (_, index) => ({
      ...
      resolvedDate: Math.random() > 0.5 ? new Date(Date.now() - Math.random() * 10 * 24 * 60 * 60 * 1000) : null,
    }))
        ...
        <div className="header-section">
          <div className="header-content">
            <div className="header-left">
              ...
              <p className="subtitle">Monitor your farm's health and track issue resolution over time</p>
            </div>
        ...
        <div className="stats-section">
          <div className="stats-grid">
            ...
            <div className="stat-card total-card">
              <div className="stat-content">
                <div className="stat-info">
                  <p className="stat-label">{t?.totalIssues || "Total Issues"}</p>
            ...
            <div className="table-header">
              ...
              <div className="table-controls">
                <div className="search-container">
                  ...
                  <input
                    type="text"
                    placeholder={t?.searchPlaceholder || "Search by Grid ID or Problem..."}
                    value={searchTerm}
                    ...
                    <tr key={index} className="table-row">
                      ...
                      <td className="table-cell">
                        <button
                          ...
                          onClick={() => {
                            const grid = gridData.find((g) => g.id === item.gridId)
